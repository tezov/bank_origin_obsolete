...
object UtilsIntent {
    ...
    suspend fun emailTo(activity: ComponentActivity, target:String, subject:String?=null, body:String?=null) = suspendCoroutine { continuation ->
    ...
    suspend fun sendTo(activity: ComponentActivity, subject:String? = null, text:String) = suspendCoroutine { continuation ->
        val intent = Intent()
    ...
    suspend fun callTo(activity: ComponentActivity, target:String) = suspendCoroutine { continuation ->
        val intent = Intent()
