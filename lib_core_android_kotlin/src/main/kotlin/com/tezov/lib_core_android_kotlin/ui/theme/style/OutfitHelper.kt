...
inline val TextStyle.asOutfitTextColor: OutfitText.StateColor get() = OutfitText.StateColor(typo = this).also { it.outfitState.nullFallback = { Color.Black }  }

inline val Int.asOutfitShapeSize: OutfitShape.Size get() = OutfitShape.Size(this)

inline val Int.asOutfitShapeColor: OutfitShape.StateColor get() = OutfitShape.StateColor(size = this.asOutfitShapeSize)
inline val Int.asOutfitBorderColor: OutfitBorder.StateColor get() = OutfitBorder.StateColor(size = this.dp)
inline val Double.asOutfitBorderColor: OutfitBorder.StateColor get() = OutfitBorder.StateColor(size = this.dp)
