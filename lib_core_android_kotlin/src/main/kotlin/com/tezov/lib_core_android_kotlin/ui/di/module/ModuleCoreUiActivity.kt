...
object ModuleCoreUiActivity {
    ...
    object State {
        ...
        class ActivityMainState @Inject constructor(
            ...
            @androidx.compose.runtime.Composable
            override fun create() = com.tezov.lib_core_android_kotlin.ui.activity.ActivityMainState.create(scaffoldState.get())
        }

        @ScopeCoreUiActivity
        class ScaffoldState @Inject constructor(): ComposableHolder<androidx.compose.material.ScaffoldState>() {
            @androidx.compose.runtime.Composable
            override fun create() = rememberScaffoldState()
        }

        @ScopeCoreUiActivity
        class SnackbarState @Inject constructor(private val scaffoldState: ScaffoldState): ComposableHolder< com.tezov.lib_core_android_kotlin.ui.activity.sub.snackbar.SnackbarState>() {
            @androidx.compose.runtime.Composable
            override fun create() = com.tezov.lib_core_android_kotlin.ui.activity.sub.snackbar.SnackbarState.create(scaffoldState.get().snackbarHostState)
        }

        @ScopeCoreUiActivity
        class BottomSheetState @Inject constructor(): ComposableHolder< com.tezov.lib_core_android_kotlin.ui.activity.sub.bottomsheet.BottomSheetState>() {
            @OptIn(ExperimentalMaterialApi::class)
            @androidx.compose.runtime.Composable
            override fun create() =  com.tezov.lib_core_android_kotlin.ui.activity.sub.bottomsheet.BottomSheetState.remember()
        }
        ...
        @ScopeCoreUiActivity
        class BottomNavigationState @Inject constructor(): ComposableHolder< com.tezov.lib_core_android_kotlin.ui.navigation.bottom_navigation.BottomNavigationState>() {
            @androidx.compose.runtime.Composable
            override fun create() =  com.tezov.lib_core_android_kotlin.ui.navigation.bottom_navigation.BottomNavigationState.create()
        }
    ...
    object Action {
        ...
        class SnackbarAction @Inject constructor(
            ...
            @androidx.compose.runtime.Composable
            override fun create() =  com.tezov.lib_core_android_kotlin.ui.activity.sub.snackbar.SnackbarAction.create(
                coroutineScope.get(),
        ...
        class BottomSheetAction @Inject constructor(
            ...
            @androidx.compose.runtime.Composable
            override fun create() =  com.tezov.lib_core_android_kotlin.ui.activity.sub.bottomsheet.BottomSheetAction.create(
                coroutineScope.get(),
        ...
        class BottomNavigationAction @Inject constructor(
            ...
            @androidx.compose.runtime.Composable
            override fun create() = com.tezov.lib_core_android_kotlin.navigation.bottom_navigation.BottomNavigationAction.create(
        ...
        class NavigationController @Inject constructor(
            ...
            @androidx.compose.runtime.Composable
            override fun create() = com.tezov.lib_core_android_kotlin.navigation.NavigationController.remember(
                snackbarAction.get()
            )
        }
    }
